...
class Catatanakhirpekan extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data = array(
			...
			'list_slide' => $this->admin->getslide("where kategori='6' ")
		);
		$this->load->view('catatanakhirpekan', $data);
	}
	...
	public function detail($slug)
	{
		...
		$this->load->view('detail_catatanakhirpekan', $data);
	}
