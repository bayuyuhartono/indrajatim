...
class Tokoh extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data = array(
			...
			'list_tokoh' => $this->admin->getberita("where kategori='Tokoh' AND tanggal <= NOW() order by tanggal DESC limit 12 "),
			'list_slide' => $this->admin->getslide("where kategori='9' ")
		);
		$this->load->view('tokoh', $data);
	}
	...
	public function detail($slug)
	{
		...
		$this->load->view('detail_tokoh', $data);
	}
