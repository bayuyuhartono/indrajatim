      ...
      <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="<?= base_url('admin/privacy_policy/actionedit');?>">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <input type="hidden" name="id" value="<?= $id;?>">
                      <textarea class="form-control" id="privacy_policy" name="privacy_policy"><?= $privacy_policy;?></textarea>
                    </div>  
                  </div>  
                </div>  
                <div class="row">
