				...
				<div class="post-item border">                
					<div class="post-item-wrap">                    
						<div class="post-image">                        
							<a href="<?= base_url('kabarjatim/detail/'.$data['id_berita']);?>">                            
						...
						<div class="post-item-description">                        
							...
							<h2 style="font-size:13px;"><a href="<?= base_url('kabarjatim/detail/'.$data['id_berita']);?>"><?= $data['judul'];?></a></h2>
							<a href="<?= base_url('kabarjatim/detail/'.$data['id_berita']);?>" class="item-link">Read More <i class="icon-chevron-right"></i></a>
						</div>                
					</div>            
				</div>
			<?php } ?>	        
